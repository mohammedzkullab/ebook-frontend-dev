...
const menuGroups = ref([
  {
    ...
    menuItems: [
      {
        icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                 <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-3.31 0-6 2.69-6 6v2h12v-2c0-3.31-2.69-6-6-6z"/>
               </svg>`,
        label: 'Users',
        route: { name: 'readers.index' }
      }
    ]
  },

  {
    menuItems: [
      {
        icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                 <path d="M4 19V5c0-1.1.9-2 2-2h12c1.1 0 2 .9 2 2v14l-8-4-8 4z"/>
               </svg>`,
        label: 'Libraries',
        route: '#',
        children: [
          { label: 'Publishing Houses', route: { name: 'Publishers.index' } },
          { label: 'Authors', route: { name: 'Authors.index' } },
          { label: 'Categories', route: { name: 'categories.index' } },
          { label: 'Books', route: { name: 'books.index' } },
          { label: 'Keywords', route: { name: 'keywords.index' } }
        ]
      }
    ]
  },
  {
    menuItems: [
      {
        icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                 <path d="M21 7h-2V4c0-1.1-.9-2-2-2H7c-1.1 0-2 .9-2 2v3H3c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm-2 13H5V10h14v10zM7 4h10v3H7V4zm5 7h-2v2H8v2h2v2h2v-2h2v-2h-2v-2z"/>
               </svg>`,
        label: 'Orders',
        route: '#',
        children: [
          { label: 'Purchase Orders', route: {name :'Purchase-Orders.index'} },
          {label: 'Carts', route: { name: 'carts.index' }}
        ]
      }
    ]
  },
  ...
  {
    icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2C10.34 2 9 3.34 9 5v1.5C6.95 7.96 6 9.86 6 12v6H4v2h16v-2h-2v-6c0-2.14-.95-4.04-3-5.5V5c0-1.66-1.34-3-3-3zm1 20c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2z"/>
    </svg>`,
    label: 'Notifications',
  ...
  },
  {
    menuItems: [
      {
        icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                   <path d="M20.59,11.17,12.83,3.41a2,2,0,0,0-1.42-.59H5A2,2,0,0,0,3,5v6.41a2,2,0,0,0,.59,1.42l7.76,7.76a2,2,0,0,0,2.83,0L20.59,14A2,2,0,0,0,20.59,11.17ZM7,7a1.5,1.5,0,1,1,1.5,1.5A1.5,1.5,0,0,1,7,7Z"/>
                </svg>
                       `,
        label: 'Offers',
        route: '',
        children: [
          { label: 'Packages', route: {name :'packages.index'} },
          { label: 'Platform Offers', route: {name :'offers.index'} },
          { label: 'Coupons', route: {name: 'codes.index'} },
        ]
      }
    ]
  },
  ...
  {
    icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 4h18c.55 0 1 .45 1 1v14c0 .55-.45 1-1 1H3c-.55 0-1-.45-1-1V5c0-.55.45-1 1-1zm2 2v12h14V6H5zm4 8h6v2H9v-2zm0-4h8v2H9v-2zm0-4h8v2H9V6z"/>
    </svg>`,
    label: 'Ads',
    route: { name: 'Ads.index' }
  }
]
  ...
  },
  {
    menuItems: [
      {
        icon: `<svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
               <path d="M4 21V8H2V21H4ZM10 21V3H8V21H10ZM16 21V12H14V21H16ZM22 21V16H20V21H22Z" />
             </svg>`,
        label: 'Reports',
        route: '',
        children: [
          { label: 'Marketing', route: {name: 'marketing.index'} },
          { label: 'Sales', route: {name: 'sales.index'} },
          { label: 'Products', route: {name: 'products.index'} },
          { label: 'Customers', route: {name: 'customers.index'} },
          { label: 'Statistical', route: {name: 'statistical.index'} },
        ]
      }
    ]
  },
    ...
    menuItems: [
      {
        ...
        route: '',
        children: [
          { label: 'Terms of Use', route: { name: 'terms.create' } },
          { label: 'About Us', route: { name: 'about.create' } },
          { label: 'Privacy', route: { name: 'privacy.create' } },
          { label: 'Contact Us', route: { name: 'Contact.create' } },
        ]
      }
    ]
  },
    ...
    menuItems: [
      {
        ...
        route: '',
        children: [
          { label:'Admins' , route: {name:'users.index'} },
          { label: 'Roles', route: { name: 'roles.index'} },
          { label: 'Currencies', route: { name: 'currencies.index'} },
          { label: 'General Settings', route: { name: 'Settings.index'} },
...
<template>
  <aside
    class="absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#f9fbfc] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 border-e border-e-stroke"
    :class="{
  ...
  >
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-4 lg:px-6 py-2">
      <router-link to="/">
        <img src="/src/assets/images/logo/Layer_1.svg" alt="Logo" class="w-50 h-30 ml-[9px]" />
      </router-link>

      <button class="block lg:hidden ps-2" @click="sidebarStore.isSidebarOpen = false">
        <svg
          class="fill-current"
          width="20"
          height="18"
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
      ...
      <nav class="px-4 lg:px-6">
        <template v-for="menuGroup in menuGroups" :key="menuGroup.name">
          <div>
            <h3 class="mb-1 ml-4 text-sm font-medium text-[#57515b] dark:text-[#ffffff]">
              {{ menuGroup.name }}
            </h3>
