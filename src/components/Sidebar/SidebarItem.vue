...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium duration-300 ease-in-out dark:text-white"
      @click.prevent="handleItemClick"
      :class="{
        'text-white bg-[#218FA7]': sidebarStore.page === item.label,
        'text-[#5a6564] hover:text-white hover:bg-[#218FA7]': sidebarStore.page !== item.label
      }"
    >
